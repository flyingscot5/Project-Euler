...
namespace Project_Euler
{
    public class Problem11V2
    {
        ...
        public void InsertToArray()
        {
            ...
            for (var y = 0; y < GridHeight; y++)
            {
                for (var x = 0; x < GridWidth; x++)
                {
                    ...
                    int nextInt = Int32.Parse(InputNumbers.Split(',')[inputNumIndex + x]);
                    _gridArray[x, y] = nextInt;
                }
            }
        }
        ...
        public int FindAdjacentNums(int x, int y, OffsetType xOffsetBehaviour, OffsetType yOffsetBehaviour)
        {
            var output = 1;
            ...
            for (var offSet = 0; offSet <= 3; offSet++)
            {
                try
                {
                    var yWithOffsetApplied = y - offSet;
